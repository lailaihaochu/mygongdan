...
package com.jinbang.gongdan.modules.act.service.ext;

import com.google.common.collect.Lists;

import com.jinbang.gongdan.common.utils.SpringContextHolder;
import com.jinbang.gongdan.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.jinbang.gongdan.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.jinbang.gongdan.modules.sys.entity.User(null, userId)))){
