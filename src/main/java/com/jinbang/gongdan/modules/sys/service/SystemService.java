...
import com.jinbang.gongdan.common.security.Digests;
import com.jinbang.gongdan.common.security.shiro.session.SessionDAO;
import com.jinbang.gongdan.common.service.BaseService;
import com.jinbang.gongdan.common.service.ServiceException;
...
import com.jinbang.gongdan.common.web.Servlets;
import com.jinbang.gongdan.modules.sys.dao.MenuDao;
import com.jinbang.gongdan.modules.sys.dao.NoteDao;
import com.jinbang.gongdan.modules.sys.dao.RoleDao;
import com.jinbang.gongdan.modules.sys.dao.UserDao;
import com.jinbang.gongdan.modules.sys.entity.*;
import com.jinbang.gongdan.modules.sys.security.SystemAuthorizingRealm;
import com.jinbang.gongdan.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public List<User> findUserByStationId(String stationId){
		return userDao.findUserByStationId(stationId);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<User> findUserByCmIdAndRoleNameLike(String cId,String roleName){
		return userDao.findUserByOfficeIdAndRoleNameLike(cId,"%"+roleName+"%");
	}

	public List<Note> findNoteList(){
		Note note=new Note();
		note.setOwner(UserUtils.getUser());
		return noteDao.findByUser(note);
	}
	@Transactional(readOnly = false)
	public void saveNote(Note note){
		if(note.getIsNewRecord()){
			note.preInsert();
			noteDao.insert(note);
		}else{
			note.preUpdate();
	...
	public Note getNote(String id) {
		return noteDao.get(new Note(id));
	}
}
