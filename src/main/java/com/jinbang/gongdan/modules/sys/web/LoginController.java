...
import com.jinbang.gongdan.common.servlet.ValidateCodeServlet;
import com.jinbang.gongdan.common.utils.CacheUtils;
import com.jinbang.gongdan.common.utils.CookieUtils;
...
import com.jinbang.gongdan.modules.sys.security.FormAuthenticationFilter;
...
//		view += ".jsp";
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// 如果已登录，再次访问主页，则退出原账号。
		System.out.println("..XXXXXXXXXXXXX..="+Global.getConfig("notAllowRefreshIndex"));
		if (Global.TRUE.equals(Global.getConfig("notAllowRefreshIndex"))){
