...
package com.jinbang.gongdan.modules.sys.security;
...
import com.jinbang.gongdan.modules.sys.entity.Menu;
...
import com.jinbang.gongdan.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		if (LoginController.isValidateCodeLogin(token.getUsername(), false, false)){
			...
			logger.debug("captcha="+token.getCaptcha()+",code="+code);
