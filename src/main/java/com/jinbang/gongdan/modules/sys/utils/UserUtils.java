...
package com.jinbang.gongdan.modules.sys.utils;
...
import com.jinbang.gongdan.common.utils.ObjectUtils;
import com.jinbang.gongdan.common.utils.SpringContextHolder;
import com.jinbang.gongdan.modules.sys.dao.*;
...
public class UserUtils {
	...
	public static List<Area> getAreaList(){
		...
		if (areaList == null){
			...
			Area.sortList(list,areaList,"0",true);
			areaList=list;
	...
	public static List<Office> getOfficeList(){
		...
		List list= Lists.newArrayList();
		Office.sortList(list,officeList,"0",true);
		officeList=list;
		return officeList;
	}
...
//			subject.logout();
	...
	public static String fmtMoney(Object number){
		String ret="";
		try{
...
//	}
public static Boolean contains(Object obj,List<Object> list){
