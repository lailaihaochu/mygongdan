...
public interface UserDao extends CrudDao<User> {
	...
	List<User> findUserByStationId(String stationId);

	List<User> findUserByWorkSheetId(String woWorksheetId,String isChecked);


	List<User> findUserByOfficeIdAndRoleNameLike(String company, String roleNameLike);
}
