...
package com.jinbang.gongdan.modules.gen.web;
...
import com.jinbang.gongdan.modules.gen.service.GenSchemeService;
import com.jinbang.gongdan.modules.gen.service.GenTableService;
import com.jinbang.gongdan.modules.gen.util.GenUtils;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.jinbang.gongdan.modules");
		}
...
//		}
	...
	public String save(GenScheme genScheme, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:" + adminPath + "/templates/modules/gen/genScheme/?repage";
	}
