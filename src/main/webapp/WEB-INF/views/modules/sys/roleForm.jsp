		...
		<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					...
					<span class="help-inline"><i class="fa fa-info-circle"></i> 工作流用户组标识</span>
				</div>
			</div>
			<div class="form-group">
				...
				<span class="help-inline" title="activiti有3种预定义的组类型：security-role、assignment、user 如果使用Activiti Explorer，需要security-role才能看到manage页签，需要assignment才能claim任务">
					...
					<form:select path="roleType" class="chosen-select" cssStyle="width:120px;">
				...
				<br/>
				<span class="help-inline" title="activiti有3种预定义的组类型：security-role、assignment、user 如果使用Activiti Explorer，需要security-role才能看到manage页签，需要assignment才能claim任务">
					<i class="fa fa-info-circle"></i>工作流组用户组类型（任务分配：assignment、管理角色：security-role、普通角色：user）</span>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">是否系统数据:</label>
				<div class="col-sm-7">
					<form:select path="sysData" cssClass="chosen-select" cssStyle="width: 80px;">
						<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<br/>
					<span class="help-inline"><i class="fa fa-info-circle"></i>“是”代表此数据只有超级管理员能进行修改，“否”则表示拥有角色修改人员的权限都能进行修改</span>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-6" >
					...
					<br/>
					<span class="help-inline"><i class="fa fa-info-circle"></i>“是”代表此数据可用，“否”则表示此数据不可用</span>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">数据范围:</label>
				<div class="col-sm-6">
					<form:select path="dataScope" class="chosen-select" cssStyle="with:200px;">
						<form:options items="${fns:getDictList('sys_data_scope')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<br/>
					<span class="help-inline"><i class="fa fa-info-circle"></i>特殊情况下，设置为“按明细设置”，可进行跨机构授权</span>
				</div>
			</div>
			<div class="form-group">
