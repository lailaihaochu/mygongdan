...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post" class="form-inline well">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="log" varStatus="vStatus">
			<tr>
				<td>${log.title}</td>
...
<%-- 					提交参数: ${fns:escapeHtml(log.params)} <br/> --%>
					<a data-toggle='collapse'href='#exmsg${vStatus.index}'>异常信息:</a> <br/>
					<div id='exmsg${vStatus.index}' class='panel-collapse collapse' aria-expanded='false'>
