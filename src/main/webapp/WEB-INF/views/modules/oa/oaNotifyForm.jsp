...
<div class="wrapper wrapper-content animated fadeInRight">
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/oaNotify/${oaNotify.self?"self":""}">通知列表</a></li>
		<li class="active"><a href="${ctx}/oa/oaNotify/${oaNotify.self?"view":"form"}?id=${oaNotify.id}${oaNotify.self?"&self=true":""}">通知<shiro:hasPermission name="oa:oaNotify:edit">${oaNotify.status eq '1' ? '查看' : not empty oaNotify.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<form:select path="type" class="form-control chosen-select required">
		...
		<c:if test="${oaNotify.status ne '1'}">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					<br/>
					<span class="help-inline"><i class="fa fa-info-circle"></i> 发布后不能进行操作。</span>
				</div>
			</div>
			<div class="form-group">
