...
<%@page import="com.jinbang.gongdan.common.web.Servlets"%>
<%@page import="com.jinbang.gongdan.common.utils.Exceptions"%>
<%@page import="com.jinbang.gongdan.common.utils.StringUtils"%>
...
<body>
	<div class="container-fluid">
		...
		<br/> <br/>
		<script>try{top.layer.close(top.mask);}catch(e){}</script>
	</div>
</body>
</html>
<%
